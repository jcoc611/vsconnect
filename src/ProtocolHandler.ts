...
export abstract class ProtocolHandler extends EventEmitter {
	...
	on(eventName: 'connected', callback: (connectionId: number, tIdConnect: number, sourceId?: number) => void): void;
	...
	trigger(eventName: 'connected', connectionId: number, tIdConnect: number, sourceId?: number): void;
